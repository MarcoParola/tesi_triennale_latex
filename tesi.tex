...
\Titolo { \vspace{35mm}Sviluppo di una app per rilevare operazioni di sollevamento manuale di carichi pesanti in contesti industriali}
\Sottotitolo {Sviluppo modulo di detection dell'azione di abbassamento}
...
\captionof{figure}{Segnale barometrico dello smartwatch.\\}
\end{center}
\end{minipage}
...
\captionof{figure}{Grafico magnetometro triassiale dello smartphone.\\}
\end{center}
\end{minipage}
\makebox[\linewidth]{}
\makebox[\linewidth]{}\makebox[\linewidth]{}\makebox[\linewidth]{}
...
\captionof{figure}{Finestra relativa ad una abbasamento del barometro dello smartwatch, barometro dello smartphone, accelerometroX smartwatch e accelerometriY smartphone.\\} 
\label{fig:finestra_abbassamento}
\end{center}
\end{minipage}
\makebox[\linewidth]{}
...
\captionof{figure}{Segnale barometrico a cui sono stati applicati i filtri a media mobile e gaussiano in cascata.\\}
\end{center}
\end{minipage}
